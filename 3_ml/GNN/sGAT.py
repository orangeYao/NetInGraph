...
print ('len(features_ll)', len(features_ll) )
print ('shapes', [i.shape for i in features_ll] )
...
for j in range(0, len(designs)):
    ...
    print ('start training!!')
    run_cora(features_ltra, net_labels_ltra, adj_lists_ltra, 
             features_ltest, net_labels_ltest, adj_lists_ltest, design)
    print ()
    print ()
